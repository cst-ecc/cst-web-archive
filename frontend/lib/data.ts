...
export const NEWS: NewsItem[] = [
  {
    ...
    imageUrl: "/images/news/remise-rapport-final.jpg",
    imageAlt: "Remise officielle du rapport final du Conseil Supérieur de Transition",
    featured: false, date: "2026-04-30",
  ...
  },
  {
    ...
    imageAlt: "Installation officielle du Conseil Supérieur de Mise en Œuvre",
    featured: true, date: "2026-06-04",
...
export const ALBUMS: GalleryAlbum[] = [
  {
    ...
    date: "2025-04-26",
    coverUrl: "/images/gallery/installation-cst-01.jpg",
    images: [
      {
        id: 1,
        title: "Installation du CST — photographie 1",
        imageUrl: "/images/gallery/installation-cst-01.jpg",
        alt: "Photographie de la cérémonie d'installation du CST",
        width: 1600,
        height: 1067,
      },
      {
        id: 2,
        title: "Installation du CST — photographie 2",
        imageUrl: "/images/gallery/installation-cst-02.jpg",
        alt: "Photographie de la cérémonie d'installation du CST",
        width: 1200,
        height: 1600,
      },
      {
        id: 3,
        title: "Installation du CST — photographie 3",
        imageUrl: "/images/gallery/installation-cst-03.jpg",
        alt: "Photographie de la cérémonie d'installation du CST",
        width: 1600,
        height: 1200,
      },
      {
        id: 4,
        title: "Installation du CST — photographie 4",
        imageUrl: "/images/gallery/installation-cst-04.jpg",
        alt: "Photographie de la cérémonie d'installation du CST",
        width: 1200,
        height: 1500,
      },
      {
        id: 5,
        title: "Installation du CST — photographie 5",
        imageUrl: "/images/gallery/installation-cst-05.jpg",
        alt: "Photographie de la cérémonie d'installation du CST",
        width: 1600,
        height: 1000,
      },
      {
        id: 6,
        title: "Installation du CST — photographie 6",
        imageUrl: "/images/gallery/installation-cst-06.jpg",
        alt: "Photographie de la cérémonie d'installation du CST",
        width: 1200,
        height: 1600,
      },
