...
function featuredLabel(item: NewsItem) {
  if (item.homeSlot === "upcoming_event") return "Événement à venir";
  if (item.homeSlot === "alert_info") return "Alerte Info";
  return "À la une";
}
          ...
          <>
            <article className={styles.featured}>
              ...
              <div className={styles.featuredBody}>
                <p className={styles.kicker}>{featuredLabel(featured)}</p>

                <time
                  dateTime={featured.eventDate ?? featured.date}
                  className={styles.date}
                >
                  {formatDate(featured.eventDate ?? featured.date)}
                </time>
